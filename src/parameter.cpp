...
//asymmetrical_bias_left_right
double asymmetrical_bias_left_gaussian_beta;
double asymmetrical_bias_right_gaussian_beta;
double asymmetrical_bias_left_gaussian_phi;
double asymmetrical_bias_right_gaussian_phi;
double asymmetrical_bias_left_right_boundary;
...
void read(string parameterFile){
    ...
    if(mode=="ArabidopsisPetal"){
        division_control="Gaussian_area"; //division frequency was set to be controlled by Gaussian function (meristem position was controlled)
    }
        ...
        division_control="area"; //division frequency was set to be controlled by area (homogeneous division frequency)
        in_division_direction = "asymmetrical_bias_left_right"; //division direction was set differently in left region and right region
    }
    else{
        cout<<"Error: current mode("<<mode<<") is invalid. Please check the spelling"<<endl;
        exit(1);
    }
...
//********************* Division Direction Control: Parameter Reading *********************
    ...
    else if(in_division_direction=="asymmetrical_bias_left_right"){
        bool is_asymmetrical_bias_left_gaussian_beta_set=0;
        bool is_asymmetrical_bias_right_gaussian_beta_set=0;
        bool is_asymmetrical_bias_left_gaussian_phi_set=0;
        bool is_asymmetrical_bias_right_gaussian_phi_set=0;
        bool is_asymmetrical_bias_left_right_boundary_set=0;

        for(int i=0;i<parameter_name.size();i++){
            if(parameter_name[i] == "asymmetrical_bias_left_gaussian_beta"){
                asymmetrical_bias_left_gaussian_beta = parameter_value[i];
                is_asymmetrical_bias_left_gaussian_beta_set = 1;
            }
            else if(parameter_name[i] == "asymmetrical_bias_right_gaussian_beta"){
                asymmetrical_bias_right_gaussian_beta = parameter_value[i];
                is_asymmetrical_bias_right_gaussian_beta_set = 1;
            }
            else if(parameter_name[i]== "asymmetrical_bias_left_gaussian_phi"){
                asymmetrical_bias_left_gaussian_phi = parameter_value[i];
                is_asymmetrical_bias_left_gaussian_phi_set = 1;
            }
            else if(parameter_name[i] == "asymmetrical_bias_right_gaussian_phi"){
                asymmetrical_bias_right_gaussian_phi = parameter_value[i];
                is_asymmetrical_bias_right_gaussian_phi_set = 1;
            }
            else if(parameter_name[i] == "asymmetrical_bias_left_right_boundary"){
                asymmetrical_bias_left_right_boundary = parameter_value[i];
                is_asymmetrical_bias_left_right_boundary_set = 1;
            }
        }
        if(is_asymmetrical_bias_left_gaussian_beta_set==0){
            std::cout<<"Error: asymmetrical_bias_left_right control parameter unset (asymmetrical_bias_left_gaussian_beta)"<<endl;
            exit(1);
        }
        if(is_asymmetrical_bias_right_gaussian_beta_set==0){
            std::cout<<"Error: asymmetrical_bias_left_right control parameter unset (asymmetrical_bias_right_gaussian_beta)"<<endl;
            exit(1);
        }
        if(is_asymmetrical_bias_left_gaussian_phi_set==0){
            std::cout<<"Error: asymmetrical_bias_left_right control parameter unset (asymmetrical_bias_left_gaussian_phi)"<<endl;
            exit(1);
        }
        if(is_asymmetrical_bias_right_gaussian_phi_set==0){
            std::cout<<"Error: asymmetrical_bias_left_right control parameter unset (asymmetrical_bias_right_gaussian_phi)"<<endl;
            exit(1);
        }
        if(is_asymmetrical_bias_left_right_boundary_set==0){
            std::cout<<"Error: asymmetrical_bias_left_right control parameter unset (asymmetrical_bias_left_right_boundary)"<<endl;
            exit(1);
        }
    }
...
//********************* Division Direction Control: Parameter std::cout *********************
    if(in_division_direction=="mochizuki_bias"){
        ...
        std::cout<<"asymmetrical_bias_left_gaussian_beta"<<" : "<<asymmetrical_bias_left_gaussian_beta<<" ";
        std::cout<<"asymmetrical_bias_right_gaussian_beta"<<" : "<<asymmetrical_bias_right_gaussian_beta<<" ";
        std::cout<<"asymmetrical_bias_left_gaussian_phi"<<" : "<<asymmetrical_bias_left_gaussian_phi<<" ";
        std::cout<<"asymmetrical_bias_right_gaussian_phi"<<" : "<<asymmetrical_bias_right_gaussian_phi<<" ";
        std::cout<<" asymmetrical_bias_left_right_boundary"<<" : "<< asymmetrical_bias_left_right_boundary<<" ";
    }
    std::cout<<endl;
...
//********************* Division Direction Control: Parameter Record *********************
    if(in_division_direction=="mochizuki_bias"){
        ...
        fout<<"asymmetrical_bias_left_gaussian_beta"<<" : "<<asymmetrical_bias_left_gaussian_beta<<endl;
        fout<<"asymmetrical_bias_right_gaussian_beta"<<" : "<<asymmetrical_bias_right_gaussian_beta<<endl;
        fout<<"asymmetrical_bias_left_gaussian_phi"<<" : "<<asymmetrical_bias_left_gaussian_phi<<endl;
        fout<<"asymmetrical_bias_right_gaussian_phi"<<" : "<<asymmetrical_bias_right_gaussian_phi<<endl;
        fout<<"asymmetrical_bias_left_right_boundary"<<" : "<<asymmetrical_bias_left_right_boundary<<endl;
    }
